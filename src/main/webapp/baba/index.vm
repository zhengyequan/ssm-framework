...
<body>
	...
	<div class="back-main"><img class="logo-main" src="../baba/img/logo_main.png"/><div class="city-sel">杭州</div><div class="visitor-count">今日访问量：<span>88888</span></div></div>
	...
	<div class="main-content">
		...
		<div class="map-parent"><img src="../baba/img/map_demo.png"/></div>
	</div>
	<div></div>
</body>
</html>